...
public class Serie {
    ...
    @OneToMany(mapppedBy = "serie", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    ...
    public Serie(DadosSerie dadosSeries) {
        ...
        this.avaliacao = OptionalDouble.of(Double.valueOf(dadosSeries.avaliacao())).orElse(0.0);
